...
export default function EarningsHub({ deals, userStats, setUserStats }: EarningsHubProps) {
    ...
    <div className="bg-white rounded-2xl border border-neutral-200 shadow-md p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-neutral-100 pb-5">
        <div>
          ...
          <p className="text-xs text-neutral-500 leading-relaxed mt-0.5">
            Earn money for routing users to buy from retail websites or stores. Generate links,
            share them, and claim your payouts instantly.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-neutral-50 rounded-xl border border-neutral-200/80 p-4 relative overflow-hidden">
          ...
          <span className="text-[9px] text-neutral-500 block mt-1">Simulated link traffic</span>
        </div>
        ...
        <div className="bg-neutral-50 rounded-xl border border-neutral-200/80 p-4 relative overflow-hidden">
          ...
          <span className="text-[9px] text-teal-600 font-bold block mt-1">
            ...
            {userStats.totalClicks > 0
              ? ((userStats.conversions / userStats.totalClicks) * 100).toFixed(1)
              : "0.0"}
            %
          </span>
        </div>
        ...
        <div className="p-3 bg-emerald-50 border border-emerald-300 text-emerald-800 rounded-xl flex items-center gap-2.5 text-xs animate-[bounce_1s_ease-in-out_1]">
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-700 mt-0.5">
              Your funds are being transferred directly to your account. Standard transfer time: 1-2
              business mins.
            </p>
          </div>
        </div>
      ...
      {activeTab === "analytics" && (
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 bg-neutral-50/50 p-4 rounded-xl border border-neutral-200">
          <div className="md:col-span-6 space-y-4">
            <h3 className="text-xs font-bold text-neutral-700 uppercase">
              Construct Your Custom Tracking Link
            </h3>
            ...
            <div>
              ...
              <span className="text-[9px] text-neutral-400 mt-1 block">
                Customize this to track conversions specifically under your account.
              </span>
            </div>
          </div>
              ...
              <div className="bg-teal-50 border border-teal-100 p-3 rounded-lg text-xs space-y-1">
                ...
                <p className="text-[11px] text-teal-800 leading-normal">
                  ...
                  <strong className="text-teal-900 font-mono">
                    ${currentDeal.referralEarningValue.toFixed(2)}
                  </strong>{" "}
                  per checkout.
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200 text-xs space-y-2">
            ...
            <p className="text-neutral-500 leading-relaxed text-[11px]">
              Post open-package deals on Reddit liquidation groups, Facebook Marketplace, or
              Telegram channels. Include drive-time comparisons to capture immediate buyers.
            </p>
          </div>
          ...
          <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200 text-xs space-y-2">
            ...
            <p className="text-neutral-500 leading-relaxed text-[11px]">
              Contractors constantly look for bargain DeWalt or Milwaukee toolkits. Post the DeWalt
              saw and tool package link on localized trade forums or Nextdoor groups.
            </p>
          </div>
          ...
          <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200 text-xs space-y-2">
            ...
            <p className="text-neutral-500 leading-relaxed text-[11px]">
              When writing posts, compare the deal to retail prices. Pointing out a $200 saving
              versus the nearest competitor builds instant trust and speeds up conversions.
            </p>
          </div>
        </div>
      )}
